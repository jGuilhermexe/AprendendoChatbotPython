...
def opcao2(mensagem):
    ...
    O atual agendamento está sendo feito diretamente com o psicólogo, a partir do seu número de telefone, ou enviando um e-mail. Nossa plataforma de agendamento online segue em desenvolvimento.
    """ 
    bot.send_message(mensagem.chat.id, texto)
...
def desabafo(mensagem):
    salvar_mensagem(mensagem.chat.id, mensagem.from_user.first_name, mensagem.text)
...
# Loop para evitar que o bot pare caso haja um erro
while True:
    try:
